...
baseDir=~/data/KeyToken/datasets/scienceqa/ScienceQA/data
baseModel='LLAVA'
...
python -m llava.eval.model_vqa_science \
    --model-path /home/ubuntu/data/KeyToken/models/llava-v1.5-7b \
    --eval-model ${baseModel} \
    --pretrained_rob_path ${modelPath} \
    --question-file "${baseDir}/llava_test_CQM-A.json" \
    --image-folder ~/data/KeyToken/datasets/scienceqa/ScienceQA/data/test \
